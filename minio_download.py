...
def main(bucket_name: str, file_name:str, download_path: str):
    ...
    client.download_csv(bucket_name, file_name, download_path)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--file_name", type=str, help="Name of the file to download (e.g. filename.csv)")
    parser.add_argument("--download_path", type=str, default="downloaded_results", help="Path to the download directory")
